define(['backbone',
    ...
    var Shutdown = Backbone.View.extend({
        
        el : '#system',
        action: '',
        preSystemTpl: Handlebars.compile(PreSystemTpl),
        shutdownTpl: Handlebars.compile(ShutdownTpl),
        poweroffTpl: Handlebars.compile(PoweroffTpl),
        ...
        render: function() {
            ...
            this.$el.html( this.preSystemTpl( {contents: this.shutdownTpl} ) );
